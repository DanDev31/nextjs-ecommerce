      ...
      <div className="flex flex-col gap-8 lg:flex-row">
        ...
        <div>
          ...
          <p className="pt-5 text-sm tracking-wide text-gray-500">
            ...
            We believe that pets are more than just animals - they are part of
            the family.
            <br /> <br /> That is why we carry a wide selection of high-quality
            products, from premium pet food to comfortable beds to interactive
            toys. We are always on the lookout for the latest and greatest
            products to help you give your pets the very best care. At our
            store, you all find a warm and welcoming environment where you and
            your pets can feel at home. We are committed to building lasting
            relationships with our customers and their furry friends, and we are
